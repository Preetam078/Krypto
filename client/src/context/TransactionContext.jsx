...
export const TransactionProvider = ({children}) => {
    ...
    const checkifTransactionExist = async() => {
        ...
        try {
            ...
            window.localStorage.getItem("transaction",transactionCount);
        } catch (error) {
            console.log(error);
            throw new Error("No ethereum Object")
        }
    ...
    return (
        <TransactionContext.Provider value={{connectWallet, currentAccount, formData, setFormData, isLoading ,transaction, handleChange, sendTransaction}}>
          {children}
